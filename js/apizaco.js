    ...
    function load() {
        var map = new google.maps.Map(document.getElementById("Apizaco"), {
        center: new google.maps.LatLng(19.4107147,-98.1400466),
        zoom: 15,
      //  mapTypeId: 'roadmap'
      });
      ...
      downloadUrl("generate-xml-apizaco.php", function(data) {
