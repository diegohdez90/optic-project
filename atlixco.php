<!DOCTYPE html >
  <head>
    ...
    <title>&Oacute;pticas localizadas en el Centro Hist&oacute;rico de la Ciudad de Atlixco</title>
    ...
    <script src="js/atlixco.js" type="text/javascript"></script>
  ...
  <body onload="load()">
    <div class="container">
      <div class="row header">
        ...
        <div class="row" id="Atlixco" style="width: 100%; height: 600px"></div>
    </div>
