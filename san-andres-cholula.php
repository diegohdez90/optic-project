<!DOCTYPE html >
  <head>
    ...
    <title>&Oacute;pticas localizadas en el Centro Hist&oacute;rico de la Ciudad de San Andrés Cholula</title>
    ...
    <script src="js/san-andres-cholula.js" type="text/javascript"></script>
  ...
  <body onload="load()">
    <div class="container">
      <div class="row header">
        <div class="col-md-8"><h2 class="text-center title">&Oacute;pticas en la Ciudad de <span>San Andrés Cholula</span><br>  Zona: Centro</h2></div>
        ...
        <div class="row" id="San_Andres_Cholula" style="width: 100%; height: 600px"></div>
    </div>
