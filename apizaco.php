<!DOCTYPE html lang="en">
  <head>
    ...
    <script src="js/apizaco.js" type="text/javascript"></script>
  ...
  <body onload="load()">
    <div class="container">
      <div class="row header">
        <div class="col-md-8"><h2 class="text-center title">&Oacute;pticas en la Ciudad de <span>Apizaco</span><br>  Zona: Centro</h2></div>
        ...
        <div class="row" id="Apizaco" style="width: 100%; height: 600px"></div>
    </div>
